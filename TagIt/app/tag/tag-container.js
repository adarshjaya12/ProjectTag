...
var tag_create_form_1 = require("./tag-create-form");
var tag_update_form_1 = require("./tag-update-form");
var tag_listing_1 = require("./tag-listing");
...
var IndexContainer = /** @class */ (function (_super) {
    ...
    IndexContainer.prototype.disableUpdateBlocK = function () {
        this.setState({
            updateTag: false
        });
    };
    ...
    IndexContainer.prototype.render = function () {
        return (React.createElement("div", null,
            (this.state.addTag) ?
                React.createElement(tag_create_form_1.default, { eventUrl: this.state.tagUrl, addUrl: this.state.addTag, updateTagList: this.updateTagList.bind(this) })
                :
                    React.createElement("div", null),
            (this.state.updateTag) ?
                React.createElement(tag_update_form_1.default, { disableUpdateBlock: this.disableUpdateBlocK.bind(this), id: this.state.tagId, eventUrl: this.state.tagUrl, title: this.state.tagTitle, imageUrl: "", tagType: this.state.tagType, updateTagList: this.updateTagList.bind(this) })
                :
                    React.createElement("div", null),
            (this.state.tagList != undefined) ?
                React.createElement(tag_listing_1.default, { updateTag: this.updateTag.bind(this), tagList: this.state.tagList, updateTagList: this.updateTagList.bind(this) })
                :
                    React.createElement("div", null)));
    };
...
//# sourceMappingURL=tag-container.js.map